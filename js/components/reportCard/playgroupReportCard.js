...
export default class PlaygroupReportCard extends Component {
              ...
              <View style={styles.tableHeader}>
                <View style={styles.rows}>
                  ...
                  <View style={[styles.cell]}>
                    <Text style={styles.center}>Very Good</Text>
                  </View>
                  <View style={[styles.cell]}>
                    <Text style={styles.center}>Good</Text>
                  </View>
                  <View style={[styles.cell,styles.noRightBorder]}>
                    <Text style={styles.center}>Emerging</Text>
                  </View>
                </View>
              </View>
                ...
                reportCard.subjects.map((item,key) => {
                  return (
                    <View style={styles.rows} key={key}>
                      ...
                      <View style={[styles.cell]}>
                      {
                        item.skill_level === 'Very Good'
                        ? <Icon style={[styles.checkIcon, styles.center]} name="md-checkmark" color="#000" />
                        : null
                      }
                      </View>
                      <View style={[styles.cell]}>
                      {
                        item.skill_level === 'Good'
                        ? <Icon style={[styles.checkIcon, styles.center]} name="md-checkmark" color="#000" />
                        : null
                      }
                      </View>
